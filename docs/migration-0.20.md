...
```bash
deno run -A jsr:@oxian/oxian-js@0.21.0-rc.4/bin init --root ./new-service
deno run -A jsr:@oxian/oxian-js@0.21.0-rc.4/bin check --config ./new-service/oxian.config.ts
```
