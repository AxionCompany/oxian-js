...
```ts
// platform/workers.ts
import { HTTP_WORKLOAD } from "jsr:@oxian/oxian-js@0.20.0-rc.1/http";
import {
  createCloudRunJobsProvider,
  createExternallyAttachedProvider,
  createLocalProcessProvider,
} from "jsr:@oxian/oxian-js@0.20.0-rc.1/providers";
import {
...
import type { WorkerIdentity } from "jsr:@oxian/oxian-js@0.20.0-rc.1/protocol";
...
const resource = await localProcesses.provision({
  ...
  launch: {
    ...
    args: [
      "run",
      "-A",
      "jsr:@oxian/oxian-js@0.20.0-rc.1/bin",
      "worker",
      "--manifest",
      "oxian.worker.ts",
    ],
