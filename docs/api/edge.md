# `jsr:@oxian/oxian-js@0.21.0-rc.2/edge`
...
import {
  ...
  createStaticAdapter,
} from "jsr:@oxian/oxian-js@0.21.0-rc.2/edge";
```
...
```ts
import { createCorsAdapter } from "jsr:@oxian/oxian-js@0.21.0-rc.2/edge";
...
```ts
import { createStaticAdapter } from "jsr:@oxian/oxian-js@0.21.0-rc.2/edge";
...
```ts
import { createDevProxyAdapter } from "jsr:@oxian/oxian-js@0.21.0-rc.2/edge";
