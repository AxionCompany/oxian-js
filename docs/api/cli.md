...
```ts
import { parseCliArgs, runCli } from "jsr:@oxian/oxian-js@0.20.0-rc.7/cli";
```
...
```ts
import type { CLI_COMMANDS } from "jsr:@oxian/oxian-js@0.20.0-rc.7/cli";
...
```sh
deno run -A jsr:@oxian/oxian-js@0.20.0-rc.7/bin --help
deno run -A jsr:@oxian/oxian-js@0.20.0-rc.7/bin start
```
