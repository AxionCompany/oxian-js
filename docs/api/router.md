# `jsr:@oxian/oxian-js@0.20.0-rc.7/router`
...
import {
  createFileRouter,
  HTTP_METHODS,
} from "jsr:@oxian/oxian-js@0.20.0-rc.7/router";
```
...
```ts
// routes/users/[id].ts
import type { RouteHandler } from "jsr:@oxian/oxian-js@0.20.0-rc.7/router";
...
import type { RouteMiddleware } from "jsr:@oxian/oxian-js@0.20.0-rc.7/router";
