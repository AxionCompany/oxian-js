# `jsr:@oxian/oxian-js@0.21.0-rc.1/router`
...
import {
  createFileRouter,
  HTTP_METHODS,
} from "jsr:@oxian/oxian-js@0.21.0-rc.1/router";
```
...
```ts
// routes/users/[id].ts
import type { RouteHandler } from "jsr:@oxian/oxian-js@0.21.0-rc.1/router";
...
import type { RouteMiddleware } from "jsr:@oxian/oxian-js@0.21.0-rc.1/router";
...
```ts
import { createFileRouter } from "jsr:@oxian/oxian-js@0.21.0-rc.1/router";
