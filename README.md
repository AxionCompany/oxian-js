...
```bash
deno run -A jsr:@oxian/oxian-js@0.21.1/bin init
deno run -A jsr:@oxian/oxian-js@0.21.1/bin dev
```
...
import { defineConfig } from "jsr:@oxian/oxian-js@0.21.1/config";
...
The executable is `jsr:@oxian/oxian-js@0.21.1/bin`; the embeddable CLI API is
`jsr:@oxian/oxian-js@0.21.1/cli`.
