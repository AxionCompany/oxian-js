...
```bash
deno run -A jsr:@oxian/oxian-js@0.20.0-rc.5/bin init
...
The executable is `jsr:@oxian/oxian-js@0.20.0-rc.5/bin`; the embeddable CLI API
is `jsr:@oxian/oxian-js@0.20.0-rc.5/cli`.
