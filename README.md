...
```bash
deno run -A jsr:@oxian/oxian-js@0.21.0-rc.2/bin init
...
```ts
import { createApplication } from "jsr:@oxian/oxian-js@0.21.0-rc.2/app";
...
The executable is `jsr:@oxian/oxian-js@0.21.0-rc.2/bin`; the embeddable CLI API
is `jsr:@oxian/oxian-js@0.21.0-rc.2/cli`.
